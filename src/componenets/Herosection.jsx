...
function HeroSection() {
  return (
    <section className="flex flex-col items-start pl-1.5 mt-16 w-full font-bold max-md:mt-10 max-md:max-w-full">
      <h1 className="text-xl text-red-400 uppercase max-md:max-w-full">
        Best Destinations around the world
      </h1>
      <p className="self-stretch mt-8 text-7xl tracking-tighter leading-[100px] text-indigo-950 max-md:max-w-full max-md:text-4xl max-md:leading-10">
        Travel, enjoy <br /> and live a new <br /> and full life
      </p>
      <p className="mt-8 text-base font-medium leading-8 text-gray-500 max-md:max-w-full">
      ...
      <div className="flex flex-wrap gap-5 justify-between mt-11 max-w-full font-medium w-[504px] max-md:mt-10">
        ...
        <div className="flex gap-7 my-auto text-2xl text-zinc-500">
          <img
            loading="lazy"
            ...
            alt=""
            className="object-contain shrink-0 aspect-square w-[69px]"
          />
          <span className="my-auto basis-auto">Play Demo</span>
        </div>
      </div>
    </section>
  );
